      ...
      <section class="bg-light py-5 py-md-5">
        <div class="container animate__animated animate__fadeInLeft">
          <div class="row gy-3 gy-md-4 gy-lg-0 align-items-md-center">
            <div class="col-12 col-lg-6">
              <div class="row justify-content-xl-center">
                <div class="col-12 col-xl-11">
                  <h3 class="h3 mb-3">Get in touch</h3><hr />
                  <p class="lead fs-5 text-secondary mb-5">We're always on the lookout to Explore with new clients. If you're interested to travel with us, please get in touch in one of the following ways.</p>
                  <div class="d-flex mb-5">
                    ...
                    <div>
                      ...
                      <address class="mb-0 text-secondary">Pune, Maharashtra, India</address>
                    </div>
                  </div>
                  <hr /><br />
                  <div class="row mb-5">
                    ...
                    <div class="col-12 col-sm-6">
                      <div class="d-flex mb-0">
                        ...
                        <div>
                          ...
                          <p class="mb-0">
                            <a class="link-secondary text-decoration-none" href="mailto:demo@yourdomain.com">bookmytrip@gmail.com</a>
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="d-flex">
                    ...
                    <div>
                      ...
                      <div class="d-flex mb-1">
                        ...
                        <p class="text-secondary mb-0">11am - 5pm</p>
                      </div>
                      <div class="d-flex">
                        <p class="text-secondary fw-bold mb-0 me-5">Sat - Sun</p>
                        <p class="text-secondary mb-0">11am - 2pm</p>
                      </div>
                    </div>
                  </div><br /><hr />
                </div>
            ...
            <div class="col-12 col-lg-6">
              <div class="bg-white border rounded overflow-hidden shadow">
